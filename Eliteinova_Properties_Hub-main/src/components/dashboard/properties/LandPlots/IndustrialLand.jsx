...
const SUB_TYPES = {
  ...
  'ManufacturingUnitPlot': {
    ...
    filterValue: 'Manufacturing Unit Plot'
  },
  'LogisticsHubLand': {
    icon: FiTruck,
    ...
    filterValue: 'Logistics Hub Land'
  },
  'WarehousePlot': {
    icon: FaWarehouse,
