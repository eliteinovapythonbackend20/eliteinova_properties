...
const VILLA_TYPE = {
  ...
  // e.g. Forms/Owner/Individual/IndSellForm.jsx).
  filterValue: 'Independent Villa'
};
...
const IndependentVilla = () => {
  ...
  const mapCard = useCallback((card) => ({
    ...
    propertyType: card.propertyType || VILLA_TYPE.label,
  ...
  const {
    ...
    fixedPropertyType: VILLA_TYPE.filterValue,
    mapCard,
