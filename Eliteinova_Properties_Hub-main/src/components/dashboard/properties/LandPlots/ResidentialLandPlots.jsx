...
const SUB_TYPES = {
  ...
  'DtcpCmdaApprovedPlot': {
    ...
    filterValue: 'DTCP & CMDA Approved Plot'
  },
  'GatedCommunityPlot': {
    icon: FiShield,
    ...
    filterValue: 'Gated Community Plot'
  },
  'VillaPlot': {
    icon: FaHome,
  ...
  'IndependentHousePlot': {
    ...
    filterValue: 'Independent House Plot'
  },
  'DuplexHousePlot': {
    icon: FiGridIcon,
