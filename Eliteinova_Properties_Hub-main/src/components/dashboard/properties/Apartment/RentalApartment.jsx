// src/components/dashboard/properties/Apartment/RentalApartment.jsx
...
import {
  ...
  FiCheckCircle, FiXCircle, FiHome, FiBriefcase, FiGlobe, FiMap, FiKey
} from 'react-icons/fi';
...
// ============================================================
// FIXED PROPERTY TYPE — this page only handles Rental Apartment
// ============================================================
...
// ============================================================
// FIXED LISTING TYPE — this page only handles Rent
// ============================================================
const RENT_TYPE = {
  icon: FiKey,
      ...
      <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-2xl animate-slide-up border border-[#E8F0EE] flex flex-col">
        ...
        <div className="sticky top-0 bg-gradient-to-r from-[#00695C] to-[#26A69A] p-6 rounded-t-3xl z-10 shrink-0">
          ...
          <div className="flex items-center gap-3 mb-2">
            <div className={`w-14 h-14 rounded-2xl ${RENT_TYPE.bg} border-2 border-white/30 flex items-center justify-center text-2xl ${RENT_TYPE.text} shadow-lg`}>
              <FiKey />
            </div>
            <div>
              <h2 className="text-2xl font-bold text-white">{property.propertyTitle}</h2>
              <p className="text-white/80 text-sm flex items-center gap-2">
                <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${RENT_TYPE.bg} ${RENT_TYPE.text} border ${RENT_TYPE.border}`}>
                  {RENT_TYPE.label}
                </span>
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-white">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-[#F5F9F8] rounded-2xl p-4">
              ...
              <p className="text-sm font-bold text-[#1A2E2A]">{RENT_TYPE.label}</p>
            </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
      <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-2xl animate-slide-up border border-[#E8F0EE] flex flex-col">
        ...
        <div className="sticky top-0 bg-gradient-to-r from-[#00695C] to-[#26A69A] p-6 rounded-t-3xl z-10 shrink-0">
          ...
          <h2 className="text-2xl font-bold text-white">Edit Rental Apartment</h2>
          <p className="text-white/80 text-sm">Update rental apartment property details</p>
        </div>
            ...
            <div className="bg-[#F5F9F8] rounded-2xl p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    type="text" value={RENT_TYPE.label} disabled
                    className="w-full px-3 py-2 bg-[#F0F4F3] rounded-xl border border-[#E8F0EE] text-sm text-[#5A7D78] outline-none cursor-not-allowed"
                  />
                </div>
...
const RentalApartment = () => {
  ...
  const handleExport = useCallback(async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `rental_apartment_${new Date().toISOString().split('T')[0]}.csv`;
      a.click();
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-[#5A7D78] flex items-center gap-2 flex-wrap">
              <span>All Rental Apartment listings for Rent</span>
                ...
                >
                  <div className="flex items-start justify-between mb-2 gap-1">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      />
                      <div className={`w-9 h-9 rounded-2xl bg-gradient-to-br ${RENT_TYPE.color} flex items-center justify-center text-white shadow-lg flex-shrink-0`}>
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 mt-0.5">
                          ...
                          <span className={`text-[9px] px-1.5 py-0.5 rounded-full font-semibold leading-none ${RENT_TYPE.bg} ${RENT_TYPE.text} border ${RENT_TYPE.border}`}>
                            {RENT_TYPE.label}
                          </span>
                        </div>
                      </div>
                ...
                >
                  <div className="col-span-2 flex items-center gap-2 min-w-0">
                    <input
                      ...
                      className="w-4 h-4 rounded border-[#B5C9C5] text-[#00695C] focus:ring-[#00695C] focus:ring-2 transition-all duration-300 flex-shrink-0"
                    />
                    <div className={`w-6 h-6 rounded-full bg-gradient-to-br ${RENT_TYPE.color} flex items-center justify-center text-white shadow-md flex-shrink-0`}>
                      <FiKey className="text-[8px]" />
                    </div>
        ...
        {paginatedProperties.length === 0 && !loading && (
          <div className="flex flex-col items-center justify-center py-20 text-center bg-white rounded-2xl border border-[#E8F0EE]">
            ...
            <p className="text-sm text-[#5A7D78] mt-1">
              {searchQuery ? 'Try adjusting your search' : 'No rental apartment listings have been added yet'}
            </p>
            {searchQuery && (
              <button
                onClick={clearSearch}
