...
const CustomerRegister = ({ isOpen, onClose, onSwitchToLogin }) => {
  ...
  const [formData, setFormData] = useState({
    fullName: '',        // ✅ Matches backend alias "fullName"
    phoneNumber: '',     // ✅ Matches backend alias "phoneNumber"
    email: '',
    address: '',
    city: '',
    state: '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const apiData = {
        ...
        fullName: formData.fullName,      // ✅ Matches backend alias
        phoneNumber: formData.phoneNumber, // ✅ Matches backend alias
