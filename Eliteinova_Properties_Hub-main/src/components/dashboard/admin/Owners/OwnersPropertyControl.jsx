// src/components/dashboard/admin/Owners/OwnersPropertyControl.jsx
...
// ============ EDIT PROPERTY MODAL (REDESIGNED - COMPACT) ============
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-3 py-1.5 bg-[#F5F9F8] rounded-lg border ${errors.ownerName ? 'border-red-400' : 'border-[#E8F0EE]'} focus:border-[#00695C] focus:ring-2 focus:ring-[#00695C]/20 transition-all duration-300 text-sm outline-none text-[#1A2E2A]`}
                placeholder="Full name"
              />
              {errors.ownerName && <p className="text-[10px] text-red-500 mt-0.5">{errors.ownerName}</p>}
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-3 py-1.5 bg-[#F5F9F8] rounded-lg border ${errors.ownerEmail ? 'border-red-400' : 'border-[#E8F0EE]'} focus:border-[#00695C] focus:ring-2 focus:ring-[#00695C]/20 transition-all duration-300 text-sm outline-none text-[#1A2E2A]`}
                placeholder="owner@email.com"
              />
              {errors.ownerEmail && <p className="text-[10px] text-red-500 mt-0.5">{errors.ownerEmail}</p>}
            </div>

            <div>
              <label className="text-[10px] font-medium text-[#5A7D78] block mb-0.5">Owner Phone</label>
              <input
                type="text"
                name="ownerPhone"
...
const ViewPropertyModal = ({ 
  ...
  const handleViewProfile = () => {
    if (onViewOwnerProfile) {
      onViewOwnerProfile(property.ownerId);
    }
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
      <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[92vh] overflow-hidden shadow-2xl animate-slide-up border border-[#E8F0EE] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          {/* Owner Info with View Profile Button */}
          <div className="flex items-center justify-between p-3 bg-[#F5F9F8] rounded-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-[#1A2E2A]">{property.ownerName || 'Unknown Owner'}</p>
                <p className="text-xs text-[#5A7D78]">Owner · {property.ownerEmail || 'No email'}</p>
              </div>
            </div>
            <button
...
const OwnersPropertyControl = () => {
  ...
  const generateMockProperties = useCallback(() => {
    ...
    const owners = [
      { id: 'owner_1', name: 'Rajesh Kumar', email: 'rajesh@email.com', phone: '+91 9876543210' },
      { id: 'owner_2', name: 'Priya Sharma', email: 'priya@email.com', phone: '+91 9876543211' },
      { id: 'owner_3', name: 'Amit Singh', email: 'amit@email.com', phone: '+91 9876543212' },
      { id: 'owner_4', name: 'Sneha Patel', email: 'sneha@email.com', phone: '+91 9876543213' },
      { id: 'owner_5', name: 'Vikram Reddy', email: 'vikram@email.com', phone: '+91 9876543214' },
      { id: 'owner_6', name: 'Deepak Verma', email: 'deepak@email.com', phone: '+91 9876543215' },
      { id: 'owner_7', name: 'Meera Joshi', email: 'meera@email.com', phone: '+91 9876543216' },
      { id: 'owner_8', name: 'Arjun Nair', email: 'arjun@email.com', phone: '+91 9876543217' },
      { id: 'owner_9', name: 'Kavya Rao', email: 'kavya@email.com', phone: '+91 9876543218' },
      { id: 'owner_10', name: 'Suresh Gupta', email: 'suresh@email.com', phone: '+91 9876543219' },
    ];
  ...
  const handleRejectProperty = useCallback((propertyId) => {
    showConfirmation({
      ...
      message: 'Are you sure you want to reject this property? The owner will be notified.',
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-[#5A7D78] flex items-center gap-2 flex-wrap">
              <span>Manage and control all property listings</span>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-1.5">
                    <button
                      type="button"
                      onClick={() => handleViewOwnerProfile(property.ownerId)}
            ...
            {paginatedProperties.map((property, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="col-span-1 text-xs text-[#5A7D78] truncate">{property.ownerName}</div>
...
export default OwnersPropertyControl;