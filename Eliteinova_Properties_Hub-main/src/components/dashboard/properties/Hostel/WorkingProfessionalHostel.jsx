...
const WORKING_PROFESSIONAL_HOSTEL_TYPE = {
  ...
  filterValue: 'Working Professional Hostel'
};
...
const WorkingProfessionalHostel = () => {
  ...
  const mapCard = useCallback((card) => ({
    ...
    propertyType: card.propertyType || WORKING_PROFESSIONAL_HOSTEL_TYPE.label,
  ...
  const {
    ...
    fixedPropertyType: WORKING_PROFESSIONAL_HOSTEL_TYPE.filterValue,
    mapCard,
