...
const SUB_TYPES = {
  'HighwayFacingPlot': {
    ...
    filterValue: 'Highway Facing Plot'
  },
  'LakeViewPlot': {
    icon: FiDroplet,
  ...
  'LayoutDevelopmentLand': {
    ...
    filterValue: 'Layout Development Land'
  },
  'FutureInvestmentPlot': {
    ...
    filterValue: 'Future Investment Plot'
  }
};
