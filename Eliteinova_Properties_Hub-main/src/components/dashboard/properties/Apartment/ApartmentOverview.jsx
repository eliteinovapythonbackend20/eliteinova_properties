...
// (ApartSellForm/ApartRentForm/ApartLeaseForm) submit to the backend - it's
// what's sent to the API and matched against BaseProperty.property_type.
// `label` is left untouched (still what's shown in the UI) even where it
// differs from filterValue (Gated Community Apartment/Condominium Apartment
// display labels vs. the real "Gated Community Studio"/"Condo Apartment"
// values). Rental/Lease/Studio keep a filterValue that matches no real
// listing (property_type is never actually "Rental Apartment", "Lease
// Apartment" or "Studio Apartment" - Rent/Lease are listing purposes and
// Studio is a bedrooms value on the real forms) - kept as-is per explicit
// product decision rather than reinterpreted to a different data dimension.
const PROPERTY_TYPES = {
  ...
  'ServicedApartment': {
    ...
    filterValue: 'Serviced Apartment'
  },
  'LeaseApartment': {
    icon: FiFileText,
  ...
  'ResidentialApartment': {
    ...
    filterValue: 'Residential Apartment'
  },
  'GatedCommunityApartment': {
    ...
    filterValue: 'Gated Community Studio'
  },
  'StudioApartment': {
    icon: FiGridIcon,
  ...
  'PenthouseApartment': {
    ...
    filterValue: 'Penthouse Apartment'
  }
};
...
const ApartmentOverview = () => {
  ...
  // count (Rental/Lease/Studio's fake filterValue will always read as 0,
  ...
  // key back to the real filterValue the posting forms use (Rental/Lease/
  // Studio's filterValue never matches a real listing, by design - see the
  // PROPERTY_TYPES comment above).
