...
const SUB_TYPES = {
  ...
  'OrganicFarmingLand': {
    ...
    filterValue: 'Organic Farming Land'
  },
  'CoconutFarmLand': {
    icon: FaTree,
  ...
  'FisheriesAquacultureLand': {
    ...
    filterValue: 'Fisheries / Aquaculture Land'
  }
};
