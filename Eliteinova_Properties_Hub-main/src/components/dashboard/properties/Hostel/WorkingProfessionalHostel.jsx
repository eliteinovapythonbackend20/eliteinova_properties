// src/components/dashboard/properties/Hostel/WorkingProfessionalHostel.jsx
...
// ============================================================
// FIXED PROPERTY TYPE — this page only handles Working Professional Hostel
// ============================================================
const WORKING_PROFESSIONAL_HOSTEL_TYPE = {
  icon: FiBriefcase,
      ...
      <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-2xl animate-slide-up border border-[#E8F0EE] flex flex-col">
        ...
        <div className="sticky top-0 bg-gradient-to-r from-[#00695C] to-[#26A69A] p-6 rounded-t-3xl z-10 shrink-0">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <span className={`px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1.5 ${WORKING_PROFESSIONAL_HOSTEL_TYPE.bg} ${WORKING_PROFESSIONAL_HOSTEL_TYPE.text} border ${WORKING_PROFESSIONAL_HOSTEL_TYPE.border}`}>
              <FiBriefcase className="text-xs" /> {WORKING_PROFESSIONAL_HOSTEL_TYPE.label}
            </span>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 bg-white">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-[#F5F9F8] rounded-2xl p-4">
              ...
              <p className="text-sm font-bold text-[#1A2E2A]">{WORKING_PROFESSIONAL_HOSTEL_TYPE.label}</p>
            </div>
...
const EditPropertyModal = ({ property, show, onClose, onSave }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    setTimeout(() => {
      onSave({ ...property, ...formData, propertyType: WORKING_PROFESSIONAL_HOSTEL_TYPE.label });
      setLoading(false);
      onClose();
    }, 700);
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
      <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-2xl animate-slide-up border border-[#E8F0EE] flex flex-col">
        ...
        <div className="sticky top-0 bg-gradient-to-r from-[#00695C] to-[#26A69A] p-6 rounded-t-3xl z-10 shrink-0">
          ...
          <h2 className="text-2xl font-bold text-white">Edit Working Professional Hostel</h2>
          <p className="text-white/80 text-sm">Update working professional hostel property details</p>
        </div>
            ...
            <div className="bg-[#F5F9F8] rounded-2xl p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    type="text" value={WORKING_PROFESSIONAL_HOSTEL_TYPE.label} disabled
...
const WorkingProfessionalHostel = () => {
  ...
  const normalizeProperties = useCallback((list) => {
    ...
    return list.map(p => ({
      ...p,
      propertyType: WORKING_PROFESSIONAL_HOSTEL_TYPE.label
    }));
  }, []);
  ...
  const generateMockProperties = useCallback(() => {
    const propertyTitles = [
      'Metro Working Professional Hostel', 'Corporate Stay Professional Hostel', 'Workhive Professional Hostel',
      'Prime Stay Professional Hostel', 'Business Bay Professional Hostel', 'Executive Nest Professional Hostel',
      'CityLink Professional Hostel', 'Riverside Professional Hostel', 'Commute Professional Hostel',
      'Junction Professional Hostel', 'Career Stay Professional Hostel', 'Skyline Professional Hostel',
      'Enclave Professional Hostel', 'Grove Professional Hostel', 'Downtown Professional Hostel',
      'Meadow Professional Hostel', 'Starlight Professional Hostel', 'Cedar Professional Hostel'
    ];
    ...
    for (let i = 1; i <= 40; i++) {
      ...
      propertiesList.push({
        id: `wp_${i}`,
        propertyId: `WP-${String(i).padStart(4, '0')}`,
        propertyTitle: propertyTitles[Math.floor(Math.random() * propertyTitles.length)],
        propertyType: WORKING_PROFESSIONAL_HOSTEL_TYPE.label,
        listingType,
        description: `A well-maintained working professional hostel with secure premises, meal facilities and easy commute to business hubs, available for ${listingType.toLowerCase()}.`,
  ...
  const handleExport = useCallback(() => {
    ...
    try {
      ...
      a.href = url;
      a.download = `working_professional_hostel_${new Date().toISOString().split('T')[0]}.csv`;
      a.click();
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-[#5A7D78] flex items-center gap-2 flex-wrap">
              <span>All Working Professional Hostel listings across Buy, Rent &amp; Lease</span>
                ...
                >
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2 text-[11px] text-[#5A7D78]">
                      ...
                      <span className="truncate font-semibold text-[#1A2E2A]">{WORKING_PROFESSIONAL_HOSTEL_TYPE.label}</span>
                    </div>
                    <div className="flex items-center gap-2 text-[11px] text-[#5A7D78]">
        ...
        {paginatedProperties.length === 0 && !loading && (
          <div className="flex flex-col items-center justify-center py-20 text-center bg-white rounded-2xl border border-[#E8F0EE]">
            ...
            <p className="text-sm text-[#5A7D78] mt-1">
              {filterCount > 0 ? 'Try adjusting your search or filter criteria' : 'No working professional hostel listings have been added yet'}
            </p>
            {filterCount > 0 && (
              <button
                onClick={clearAllFilters}
