...
// import { searchByCategory,searchByPropertyType, searchProperties } from "../../services/filterService";
...
//   // const pathToHouseType = new Map(
//   //   houseTypes.map(type => [type.path, type.name])
//   // );
  
//   // useEffect(() => {
//   //   const currentPath = location.pathname;
//   //   const activeTypeName = pathToHouseType.get(currentPath);
    
//   //   if (activeTypeName && activeTypeName !== activeHouseType) {
//   //     setActiveHouseType(activeTypeName);
//   //   }
    
//   //   if (pathToHouseType.has(currentPath)) {
//   //     fetchFilteredData(currentPath);
//   //   }
//   // }, [location.pathname, activeHouseType]);
  
//   // const fetchFilteredData = async (currentPath) => {
//   //   try {
//   //     const typeName = pathToHouseType.get(currentPath);
//   //     if (!typeName) return;
//   //     if (typeName === "All") {
//   //       const response = await searchByCategory("INDIVIDUAL");
//   //       console.log("Category Response:", response);
//   //       return;
//   //     }
//   //     const response = await searchByPropertyType(typeName);
//   //     console.log("Property Type Response:", response);
