...
class PropertyManagementProperty(Base):
    __tablename__ = "property_management_properties"
    ...
    property = relationship("BaseProperty", back_populates="property_management_details")